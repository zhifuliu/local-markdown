...
var gulp = require('gulp'), rjs = require('gulp-requirejs-bundler'), concat = require('gulp-concat'), clean = require('gulp-clean'),
    replace = require('gulp-replace'), uglify = require('gulp-uglify'), htmlreplace = require('gulp-html-replace'), typescript = require('gulp-tsc'), webServer = require('gulp-webserver'), gutil = require('gulp-util');
...
gulp.task('css', function () {
    var bowerCss = gulp.src('./src/front/bower_modules/components-bootstrap/css/bootstrap.min.css')
        ...
        fontFiles = gulp.src('./src/front/bower_modules/components-bootstrap/fonts/!*', { base: './src/front/bower_modules/components-bootstrap/' });
...
gulp.task('clean', function() {
    var distContents = gulp.src('./dist/**/*', { read: false }),
        generatedJs = gulp.src(['./src/front/**/*.js', './src/front/**/*.js.map', 'test/**/*.js', 'test/**/*.js.map'], { read: false })
